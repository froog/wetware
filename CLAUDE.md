...
- `assets/` — `david.png` (source for dithering), ambient audio files, `apples/apple01-21.jpg` (About This Jacket gallery: click the menu-bar Apple glyph, click the apple for another apple)
